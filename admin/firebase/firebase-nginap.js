...
var pemateriRef = db.ref("nginap/pemateri");

//referensi untuk tambah data 
var addpemateriRef = db.ref("nginap/pemateri/" + id);
//referensi untuk tampilkan data
var pesertaRef = db.ref("nginap/peserta");

//referensi untuk tambah data 
var addpesertaRef = db.ref("nginap/peserta/" + id);

// PEMATERI SECTION
/*================Mengambil data dari form=================*/
document.getElementById("form-pemateri").addEventListener("submit", e => {
    var nama = document.getElementById("nama-nginap").value;
    var hari = document.getElementById("hari-nginap").value;
...
function createPemateri(id, nama, hari, image) {
    ...
    var storageRef = firebase.storage().ref('nginap/pemateri/' + imageName);
...
function editPemateri(id) {
    ...
    var query = db.ref('nginap/pemateri/' + id);
    ...
    document.getElementById("form-pemateri-edit").addEventListener("submit", e => {
        ...
        //firebase  storage reference
        //it is the path where yyour image will store
        var storageRef = firebase.storage().ref('nginap/pemateri/' + imagenameEdit);
        //upload image to selected storage reference
...
function editPeserta(id) {
    ...
    var query = db.ref('nginap/peserta/' + id);

...
var pemateriRef = db.ref("multimedia/pemateri");

//referensi untuk tambah data 
var addpemateriRef = db.ref("multimedia/pemateri/" + id);
//referensi untuk tampilkan data
var pesertaRef = db.ref("multimedia/peserta");

//referensi untuk tambah data 
var addpesertaRef = db.ref("multimedia/peserta/" + id);

// PEMATERI SECTION
/*================Mengambil data dari form=================*/
document.getElementById("form-pemateri").addEventListener("submit", e => {
    var nama = document.getElementById("nama-multimedia").value;
    var hari = document.getElementById("hari-multimedia").value;
...
function createPemateri(id, nama, hari, image) {
    ...
    var storageRef = firebase.storage().ref('multimedia/pemateri/' + imageName);
...
function editPemateri(id) {
    ...
    var query = db.ref('multimedia/pemateri/' + id);
    ...
    document.getElementById("form-pemateri-edit").addEventListener("submit", e => {
        ...
        //firebase  storage reference
        //it is the path where yyour image will store
        var storageRef = firebase.storage().ref('multimedia/pemateri/' + imagenameEdit);
        //upload image to selected storage reference
...
function editPeserta(id) {
    ...
    var query = db.ref('multimedia/peserta/' + id);

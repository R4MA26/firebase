...
var pemateriRef = db.ref("program/pemateri");

//referensi untuk tambah data 
var addpemateriRef = db.ref("program/pemateri/" + id);
//referensi untuk tampilkan data
var pesertaRef = db.ref("program/peserta");

//referensi untuk tambah data 
var addpesertaRef = db.ref("program/peserta/" + id);

// PEMATERI SECTION
/*================Mengambil data dari form=================*/
document.getElementById("form-pemateri").addEventListener("submit", e => {
    var nama = document.getElementById("nama-program").value;
    var hari = document.getElementById("hari-program").value;

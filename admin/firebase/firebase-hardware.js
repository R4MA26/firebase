...
var pemateriRef = db.ref("hardware/pemateri");

//referensi untuk tambah data 
var addpemateriRef = db.ref("hardware/pemateri/" + id);
//referensi untuk tampilkan data
var pesertaRef = db.ref("hardware/peserta");

//referensi untuk tambah data 
var addpesertaRef = db.ref("hardware/peserta/" + id);

// PEMATERI SECTION
/*================Mengambil data dari form=================*/
document.getElementById("form-pemateri").addEventListener("submit", e => {
    var nama = document.getElementById("nama-hardware").value;
    var hari = document.getElementById("hari-hardware").value;
...
function createPemateri(id, nama, hari, image) {
    ...
    var storageRef = firebase.storage().ref('hardware/pemateri/' + imageName);
...
function editPemateri(id) {
    ...
    var query = db.ref('hardware/pemateri/' + id);
    ...
    document.getElementById("form-pemateri-edit").addEventListener("submit", e => {
        ...
        //firebase  storage reference
        //it is the path where yyour image will store
        var storageRef = firebase.storage().ref('hardware/pemateri/' + imagenameEdit);
        //upload image to selected storage reference
...
function editPeserta(id) {
    ...
    var query = db.ref('hardware/peserta/' + id);
